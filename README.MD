...
1. Add `--dry-run` option to print out all changes to console
2. Add ability to exclude folders, or files using regex pattern
3. Add argument for only searching in certain file types
