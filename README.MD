# RustyWind [![Build Status](https://travis-ci.org/avencera/rustywind.svg?branch=master)](https://travis-ci.org/avencera/rustywind)
...
Run rustywind with a path to output updated file contents to the console:
  - `rustywind .`
